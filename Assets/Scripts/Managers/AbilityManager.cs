...
public class AbilityManager : MonoBehaviour
{
	...
	{
		string oldDamage = _damage.ToString();

		int damageDifference = _newDamage - _damage;
		string newDamageUpgrade = "+ " + damageDifference;
	...
	{
		string oldCount = _oldCount.ToString();

		int difference = _newCount - _oldCount;
		string str_Difference = "+ " + difference;
	...
	{
		string oldFireRate = _oldFireRate.ToString("F2") + "s";

		float difference = _oldFireRate - _newFireRate;
		string str_Difference = "- " + difference.ToString("F2") + "s";
	...
	{
		string oldSpawnRate = _oldSpawnRate.ToString("F2") + "s";
	...
	{
		string oldActiveTime = _oldActiveTime + "s";

		float difference = _newActiveTime - _oldActiveTime;
		string str_Difference = "+ " + difference + "s";
	...
	{
		string oldFireRate = _oldFireRate + "%";
	...
	{
		string oldFireRate = _oldMaxHealth + "%";
    ...
    {
		string oldMS = _oldValue + "%";

		float difference = _newValue - _oldValue;
		string str_Difference = "+ " + difference + "ms";
